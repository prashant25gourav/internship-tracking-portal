    ...
    <div style={styles.container}>
      ...
      <aside style={styles.sidebar}>
        ...
        <nav style={styles.navLinks}>
          <button onClick={() => navigate("/student")} style={styles.navButton}>
            Dashboard
          </button>
          <button
      ...
      <main style={styles.mainContent}>
        <header style={styles.header}>
          <h1 style={styles.mainHeading}>
            Submit Internship Completion Report
          </h1>
          <p style={{ color: "#aaa", margin: 0 }}>
            Upload your final industry evaluation certificates and project
            documentation for departmental review.
          </p>
        </header>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <div style={styles.inputGroup}>
              <label style={styles.label}>
                Brief Work Description & Core Accomplishments
              </label>
              <textarea
                rows="5"
            ...
            <div style={styles.inputGroup}>
              <label style={styles.label}>
                Attach Final Evaluation Certificate (PDF format)
              </label>
              <div style={styles.fileUploadBox}>
                ...
                <label htmlFor="pdf-upload" style={styles.fileLabel}>
                  {file
                    ...
                    : "📁 Click to select or drop your completion PDF here"}
                </label>
              </div>
            </div>
